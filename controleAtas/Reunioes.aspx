    ...
    <form id="form1" runat="server" defaultbutton="Button7" defaultfocus="txtNome">
        <fieldset id="Fieldset1" class="fieldset" runat="server" align="middle" style="z-index: 100;
            ...
            <div>
                &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                <div style="z-index: 109; left: 2%; width: 358px; position: absolute; top: 87%; height: 41px">
                ...
                <asp:Label ID="lblCriador" runat="server" Style="z-index: 103; left: 2%; position: absolute;
                    top: 383px" Text="Criador:" Visible="False"></asp:Label>
                <asp:TextBox ID="txtLocal" runat="server" MaxLength="100" Style="z-index: 104; left: 2%;
                ...
                <asp:TextBox ID="txtCriador" runat="server" Enabled="False" Height="16px" MaxLength="100"
                    Style="z-index: 104; left: 12%; position: absolute; top: 383px" TabIndex="2"
                    Visible="False" Width="260px"></asp:TextBox>
                &nbsp;
                &nbsp;&nbsp;
                <asp:TextBox ID="txtAssunto" runat="server" Style="z-index: 105; left: 2%; position: absolute;
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtAssunto"
                    ErrorMessage="* campo obrigatório" Style="z-index: 106; left: 335px; position: absolute;
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtLocal"
                    ErrorMessage="* campo obrigatório" Style="z-index: 107; left: 335px; position: absolute;
                    top: 89px" SetFocusOnError="True"></asp:RequiredFieldValidator>
                &nbsp; &nbsp; &nbsp; &nbsp;
                <uc3:Calendario ID="DtReuniao" runat="server" left="10" top="128" />
                <asp:ListBox ID="lstParticipantes" runat="server" Height="208px" Style="z-index: 110; left: 2%;
                    position: absolute; top: 172px" Width="320px" SelectionMode="Multiple"></asp:ListBox>
            </div>
        </fieldset>
        &nbsp;&nbsp;
